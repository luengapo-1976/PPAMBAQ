...
export class PublicadorFormDialog {
  ...
  private populateForm(record: Publicador, opts: { enableWorkflowFields: boolean }): void {
    ...
    this.form.patchValue({
      ...
      fecha_solicitud: toDateInputValue(record.fecha_solicitud),
      estado: record.estado,
      entrenamiento_requerido: record.entrenamiento_requerido,
      fecha_aprobacion: toDateInputValue(record.fecha_aprobacion),
      fecha_cumple_requisitos: toDateInputValue(record.fecha_cumple_requisitos),
